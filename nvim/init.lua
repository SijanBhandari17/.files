...
require('lazy').setup({
      ...
      require('telescope').setup {
        ...
        defaults = {
          ...
          file_ignore_patterns = {
            'node_modules', -- ignore anything inside node_modules
          },
        },
        -- pickers = {}
  ...
  },
  {
    ...
    config = function()
      ...
      -- Extend with nvim-cmp capabilities
        ...
        html = {
          ...
          init_options = {
            ...
            emmet = {
              ...
              showSuggestionsAsSnippets = true, -- Try changing to false
            },
          },
          capabilities = vim.deepcopy(capabilities), -- Ensure capabilities are explicitly passed
        },
        lua_ls = {
          -- cmd = { ... },
          -- filetypes = { ... },
  ...
  --
  --  Uncomment the following line and add your plugins to `lua/custom/plugins/*.lua` to get going.init
